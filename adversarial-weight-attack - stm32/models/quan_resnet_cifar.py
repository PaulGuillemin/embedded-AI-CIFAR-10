...
class CifarResNet(nn.Module):
  ...
  """
    ...
    """
        ...
        self.drop2d_0 = torch.nn.Dropout2d(p=0.1, inplace=False)
        self.drop2d_1 = torch.nn.Dropout2d(p=0.1, inplace=False)
        self.drop2d_2 = torch.nn.Dropout2d(p=0.1, inplace=False)
        self.drop2d_3 = torch.nn.Dropout2d(p=0.1, inplace=False)
